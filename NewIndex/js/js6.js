...
>>>>>>> cb6f78c16e5703fe75d58b42c81c69c5e7f8df8d
                v.data(e, n, r)
            } else r = t
        }
        return r
...
function hideDialog(id) {
    $("#layer").fadeOut(300);
    $("#" + id).removeClass("pop-down").addClass("pop-up");
    setTimeout(function () {
        $("#" + id).stop(true, true).removeClass("pop-up");
    }, 501)
}
...
$(window).scroll(function (event) {
    ...
    $(".auto-play-video video").each(function () {
        var th = $(this).offset().top;
        var hasPlay = $(this).data("hasplay");
        if (afterScrollTop + wh > th && hasPlay == undefined) {
            this.play();
            $(this).data("hasplay", "true");
        }
        // else {
        //     this.pause();
        // }
...
function initPageTop() {
    ...
    // 动态语言切换时，默认显示的语言站名称
    if ($(".lang-box ul.language-switcher-locale-url li.active").hasClass("en")) {
        var langtxt = "English";
<<<<<<< HEAD
    } else if ($(".lang-box ul.language-switcher-locale-url li.active").hasClass("zh-hans")) {
=======
    }
    else if ($(".lang-box ul.language-switcher-locale-url li.active").hasClass("zh-hans")) {
>>>>>>> cb6f78c16e5703fe75d58b42c81c69c5e7f8df8d
    ...
    $(".header .lang-box span.lang").text(langtxt);

    // 如果中文页面没有对应英文翻译，则切换英文站时直接到英文站首页
    if ($(".lang-box ul.language-switcher-locale-url li.en span").hasClass('locale-untranslated')) {
        $(".lang-box ul.language-switcher-locale-url li.en span").css({
            "text-decoration": "none"
        }).wrap('<a href="/en"></a>');
    }
    //切换语言时都到首页
    if ($(".lang-box ul.language-switcher-locale-url li.zh-hans a").length) {
        $(".lang-box ul.language-switcher-locale-url li.zh-hans a").attr("href", '/cn');
    }
    if ($(".lang-box ul.language-switcher-locale-url li.en a").length) {
        $(".lang-box ul.language-switcher-locale-url li.en a").attr("href", '/en');
    }

    /*
    var lang =  getLocationFirstPath();
    if(lang == "en") {
        $(".header .lang-box span.lang").text("English");
        $(".lang-box ul.language-switcher-locale-url li.en").addClass("active").siblings("li").removeClass("active");
    }*/
...
function initBanner() {
    // $(".banner, .page-banner").each(function(){
...
function getData(params, fn) {
    $.ajax({
        url: 'https://api-staging003.mokahr.com/v1/jobs/yitutest',
        data: params,
        type: 'Get',
...
$(function () {
    ...
    if (_isMobile) {
        $(".nav li.expanded > a").attr("href", "javascript:;").click(function (event) {
            var _e = event || window.event;
            _e.preventDefault();
        });

        $(".top-banner .videobox").remove();
        $(".top-banner .swiper-slide").each(function () {
...
>>>>>>> cb6f78c16e5703fe75d58b42c81c69c5e7f8df8d
    ...
    $(".radio-group .radio").click(function () {
        ...
        $(this).parent(".radio-group").data("val", val);
    })
    ...
    $(".header").on("hover",".lang-box",function () {
    ...
    // $(".lang-box ul li").click(function () {
    //     var txt = $(this).text();
    //     $(this).find("a").addClass("active").parent("li").siblings("li").find("a").removeClass("active");
    //     $(this).parents(".lang-box").find("span").text(txt);
    // })
    /* $(document).click(function(){
<<<<<<< HEAD
         if( $(".header .lang-box ul").is(":visible")) {
             $(".header .lang-box").removeClass("toggle");
         }
     })*/
=======
        if( $(".header .lang-box ul").is(":visible")) {
...
>>>>>>> cb6f78c16e5703fe75d58b42c81c69c5e7f8df8d
    ...
    $(".block-system").each(function () {
        if ($(this).parents(".w").length || $(this).find(".w").length) {
            return
<<<<<<< HEAD
        } else {
=======
...
>>>>>>> cb6f78c16e5703fe75d58b42c81c69c5e7f8df8d
            if ($.trim($(this).html()) != "") {
                ...
                $(this).css("background", "#ffffff").wrapInner('<div class="node-wrapper"></div>');
                $(this).find(".node-wrapper").wrapInner('<div class="w"></div>')
            } else {
                $(this).remove();
            }
        }
    ...
    var pageBanner = new Swiper(".page-banner .swiper-container", {
        ...
        on: {
            init: function () {
                $(".page-banner video").each(function (i) {
                    if (i == 0) {
                        this.play();
                    }
                })
...
>>>>>>> cb6f78c16e5703fe75d58b42c81c69c5e7f8df8d
    ...
    $("#partnerLanding .to-apply").click(function () {
        ...
        showDialog('partnerForm');
        /*$("#applyForm .form-submit").attr("disabled","disabled");
         if($("#edit-submitted-accept-1").attr("checked")=="checked") {
         $("#applyForm .form-submit").removeAttr("disabled");
         }
         $("#edit-submitted-accept-1").click(function(){
    ...
    $("#partnerLanding .to-consult").click(function () {
        hideDialog('partnerLanding');
        showDialog('consultForm');
    })

    $(".pop a.close").click(function () {
        var id = $(this).parents(".pop").attr("id");
        hideDialog(id);
    })
    ...
    $(document).on("click", ".speech", function () {
        window._hmt && _hmt.push(['_trackEvent', 'speech.yitutech.com', '跳转至智能语音网站', '智能语音']);
    })
    $(document).on("click", ".job-list a.submit", function () {
        var jobTitle = $(this).parents("li").find(".overview").find("h5").text();
        window._hmt && _hmt.push(['_trackEvent', 'app.mokahr.com', '跳转至MOKA', jobTitle]);
    })
    $(document).on("click", ".kms", function () {
        window._hmt && _hmt.push(['_trackEvent', 'kms.yitutech.com', '跳转至蓝凌系统', '蓝凌系统']);
    })
})
